...
interface IXudService_ISubscribeSwaps extends grpc.MethodDefinition<xudrpc_pb.SubscribeSwapsRequest, xudrpc_pb.Swap> {
    ...
    responseSerialize: grpc.serialize<xudrpc_pb.Swap>;
    responseDeserialize: grpc.deserialize<xudrpc_pb.Swap>;
}
...
export interface IXudServer {
    ...
    subscribeSwaps: grpc.handleServerStreamingCall<xudrpc_pb.SubscribeSwapsRequest, xudrpc_pb.Swap>;
}
